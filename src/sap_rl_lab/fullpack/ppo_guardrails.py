...
def train_guarded(
    ...
    *,
    ...
    if catalog.rules_version not in {5, 6, 7, 8} or game.shop_action_limit_mode != "force_battle":
        raise ValueError("this runner requires a supported force-battle contract")
