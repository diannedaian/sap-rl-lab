"""Third bounded Tier4 continuation, preserving every earlier frozen experiment."""
...
import train_tier4_long2 as prior_run
...
ROOT = parent.ROOT
PARENT = ROOT / "runs/tier4-long2-v1"
PRIOR_EVAL = PARENT / "evaluation"
PLAN = ROOT / "docs/TIER4_LONG3_PLAN.md"
STEPS, INTERVAL = 1_048_576, 262_144
TRAIN_SEEDS = (57101, 57201, 57301)
SOURCE_SEGMENT_STEPS, SOURCE_LINEAGE_STEPS = 1_048_576, 4_194_304
TEST_SEED, MAX_SECONDS = 70_000_000, 7200
...
def prepare(output):
    ...
    for path in (
        PLAN,
        Path(__file__),
        ROOT / "tests/test_tier4_long3.py",
