...
spec = importlib.util.spec_from_file_location("train_tier4_long2", SCRIPTS / "train_tier4_long2.py")
...
def test_second_segment_preserves_lineage_and_fresh_testing():
    assert long.SOURCE_SEGMENT_STEPS == 1048576
    assert long.SOURCE_LINEAGE_STEPS == 3145728
    assert long.SOURCE_LINEAGE_STEPS + long.STEPS == 4194304
    assert long.TEST_SEED == 69000000
