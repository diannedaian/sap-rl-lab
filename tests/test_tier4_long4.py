...
spec = importlib.util.spec_from_file_location("train_tier4_long4", SCRIPTS / "train_tier4_long4.py")
...
def test_fourth_segment_preserves_lineage_and_fresh_testing():
    assert long.SOURCE_SEGMENT_STEPS == 1048576
    assert long.SOURCE_LINEAGE_STEPS == 5242880
    assert long.SOURCE_LINEAGE_STEPS + long.STEPS == 6291456
    assert long.TEST_SEED == 71000000
